...
class ScheduleViewPagerAdapter(private val context: Context): ListAdapter<Schedule, ScheduleViewPagerAdapter.ScheduleViewHolder>(ScheduleItemCallback()) {
...
//        }
    ...
    override fun getItemViewType(position: Int): Int {
        return if (currentList[position].lessons.isEmpty()) EMPTY_DAY
        else NO_EMPTY_DAY
    }

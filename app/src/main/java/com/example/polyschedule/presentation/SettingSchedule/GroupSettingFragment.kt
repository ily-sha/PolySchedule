...
class GroupSettingFragment : Fragment() {
    ...
    private lateinit var showBottomNav: ShowBottomNav
    override fun onAttach(context: Context) {
        ...
        groupSettingViewModel.getGroups(args.value.course, args.value.institute)
    }
    ...
    private val args by lazy {
        navArgs<GroupSettingFragmentArgs>()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.continueButton.setOnClickListener {
            groupSettingViewModel.selectedGroup.value?.let {
                val direction = Direction(it, args.value.institute)
                groupSettingViewModel.setMainDirection(direction)
                findNavController().navigate(
                    GroupSettingFragmentDirections.actionGroupSettingFragmentToScheduleFragment(
                        direction
                    )
                )
